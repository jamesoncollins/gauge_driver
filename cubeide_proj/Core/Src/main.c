...
void My_MX_USART1_UART_Init(int baudrate)
{
  /*
   * this is a copy of the code that the HAL automatically generates.
   *
   * but we made our own version becuase we want to control the baud rate.
   */
  if(baudrate)
  {
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13|GPIO2_Pin|GPIO_PIN_6|PWREN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RESET_MOTOR_Pin|DIR_TACH_Pin|DIR_SPEED_Pin|SPI_LCD_nCS_Pin
                          |STEP_TACH_Pin|STEP_SPEED_Pin|SPI_FLASH_nCS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PC13 GPIO2_Pin PC6 PWREN_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_13|GPIO2_Pin|GPIO_PIN_6|PWREN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : RESET_MOTOR_Pin DIR_TACH_Pin DIR_SPEED_Pin SPI_LCD_nCS_Pin
                           STEP_TACH_Pin STEP_SPEED_Pin SPI_FLASH_nCS_Pin */
  GPIO_InitStruct.Pin = RESET_MOTOR_Pin|DIR_TACH_Pin|DIR_SPEED_Pin|SPI_LCD_nCS_Pin
                          |STEP_TACH_Pin|STEP_SPEED_Pin|SPI_FLASH_nCS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : PC11 GPIO1_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_11|GPIO1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
